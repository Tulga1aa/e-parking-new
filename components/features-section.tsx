        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-12 ">
            <div className="space-y-4">
              <h2 className="text-3xl lg:text-3xl font-bold text-green-500">БИДНИЙ ЗОРИЛГО</h2>
              <p className=" text-lg leading-relaxed">
                Нийтийн ээмшийн 50 байршил дахь төлбөртэй зогсоолын менежментийг сайжруулах
              </p>
            </div>
            <div className="space-y-4">
              <h3 className="text-2xl lg:text-3xl font-bold  text-green-500">БИДНИЙ ҮНЭТ ЗҮЙЛ</h3>
              <p className=" text-lg leading-relaxed">
            ...
            <div className="space-y-4">
              <h3 className="text-2xl lg:text-3xl font-bold text-green-500">БИДНИЙ УРИА</h3>  
              <p className=" text-lg leading-relaxed">Хэзээч ийм амар байсангүй</p>
            </div>
          </div>
